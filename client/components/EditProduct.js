...
import { fetchAllProducts, fetchSingleProduct, setSingleProduct, updateProduct } from '../store/adminproducts';
  ...
  render() {
    return(
      <form id="edit-product" onSubmit={this.handleSubmit}>
        ...
        <input name="brand" value={this.state.brand} onChange={this.handleChange}></input>

        <label htmlFor="category">Category: </label>
        <input name="category" value={this.state.category} onChange={this.handleChange}></input>

        <label htmlFor="price">Price (in cents): </label>
        <input name="price" value={this.state.price} onChange={this.handleChange}></input>

        <label htmlFor="imageUrl">Image </label>
        <input name="imageUrl" value={this.state.imageUrl} onChange={this.handleChange}></input>
        </div>
